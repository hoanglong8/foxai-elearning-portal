      ...
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md text-center space-y-6">
        ...
        <div className="border-t pt-6 space-y-4">
          <p className="text-sm text-gray-600">
            Đăng nhập bằng tài khoản Google FOXAI của bạn
          </p>
          <Button
            onClick={signInWithGoogle}
            disabled={loading}
            className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl flex items-center justify-center gap-3"
          >
            {loading ? (
        ...
        <p className="text-xs text-gray-400">
          Chỉ dành cho nhân viên FOXAI Technology
        </p>
      </div>
    </div>
  )
